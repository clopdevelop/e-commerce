...
import { getPaymentMethodsByUser, savePayMethod } from "@/lib/actionscommands";
import { CreditCard, EuroIcon, Apple } from "lucide-react";

export default async function PayMethodForm() {
    ...
    {/* <div className="grid gap-4">
      ...
      <div className="grid grid-cols-3 gap-4 mt-2">
        <select id="month" name="month" className="Input">
          <option value="" disabled selected hidden>{(payment?.expirationMonth) ? payment.expirationMonth : "Mes"}</option>
