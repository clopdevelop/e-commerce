// Thanks to @mxkashke https://github.com/mxkaske/mxkaske.dev/blob/feat/multi-select-form/components/craft/fancy-multi-select.tsx
"use client";
...
export const ProductTags = ({ onChange }: Props) => {
